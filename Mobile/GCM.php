...
class GCM
{
     ...
     public function call_service($service,$postData)
    {
        ...
        switch($service)
        {
            case "sendPushIOS":
            {
                return $this->sendPushiOS($deviceToken, $subject,$message);
                //return $this->sendPushiOS($deviceToken,$subject,$pushMessage);
            }
                break;
            case "senPushAndroid":
            {
                return $this->sendPushToAndroid($deviceToken, $payload,$isNotificationType);
                //return $this->sendPushToAndroid($deviceToken, $payload,$isNotificationType);
            }
            break;
        }
    ...
    public function sendPushiOS($deviceToken,$subject,$message)
    {
       ...
       // print_r($deviceToken);exit;
        ...
        $apns = stream_socket_client(
            ...
            $error_string, 60, STREAM_CLIENT_CONNECT | STREAM_CLIENT_PERSISTENT, $stream_context);
