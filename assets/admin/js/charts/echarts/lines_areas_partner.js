    ...
    require(
            ...
            // Charts setup
                    function (ec, limitless) {
                        ...
                        //
                        if (data != "") {
                            Xindex = [], Yindex1 = [], Yindex2 = [], Yindex3 = [], Yindex4 = [], Yindex5 = [], Yindex6 = [], Yindex7 = [];
                            $.each(data.key_array, function (i, v) {
                                Xindex.push(v[1]);
                            });
                            $.each(data.key_array, function (i, v) {
                                if (data.registered_users[v[0]] != undefined) {
                                    var obj = data.registered_users[v[0]];
                                    Yindex7.push(obj[0]);
                                } else {
                                    Yindex7.push(0);
                                }
...
//                                $.each(data.checked_in_users, function (i, v) {
//                                    Yindex1.push(v[0]);
//                                });
//                                $.each(data.total_images, function (i, v) {
//                                    Yindex2.push(v[0]);
//                                });
                            $.each(data.key_array, function (i, v) {
...
//                                $.each(data.total_matches, function (i, v) {
//                                    Yindex3.push(v[0]);
//                                });
                            $.each(data.key_array, function (i, v) {
...
//                                $.each(data.free_images_purchased, function (i, v) {
//                                    Yindex4.push(v[0]);
//                                });
                            $.each(data.key_array, function (i, v) {
...
//                                $.each(data.registered_businesses, function (i, v) {
//                                    Yindex5.push(v[0]);
//                                });
                            $.each(data.key_array, function (i, v) {
                                if (data.registered_businesses[v[0]] != undefined) {
                                    var obj = data.registered_businesses[v[0]];
                                    Yindex5.push(obj[0]);
                                } else {
                                    Yindex5.push(0);
                                }
                            });
//                                $.each(data.invited_businesses, function (i, v) {
//                                    Yindex6.push(v[0]);
//                                });
                            $.each(data.key_array, function (i, v) {
                                if (data.invited_businesses[v[0]] != undefined) {
                                    var obj = data.invited_businesses[v[0]];
                                    Yindex6.push(obj[0]);
                                } else {
                                    Yindex6.push(0);
                                }
...
//                                }
                            ...
                            legend: {
                                x: 'left',
                                data: ['Registered Businesses', 'Invited Businesses', 'Registered Users', 'Checkedin Users', 'Uploaded Images', 'Total matches(verified)', 'Free Images Purchased']
                            },
                            // Display toolbox
                            toolbox: {
                                show: true,
