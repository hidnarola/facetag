...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading text-right">
            <a href="<?php echo site_url('business/hotels/add/' . $business_data['id']); ?>" class="btn btn-success btn-labeled"><b><i class="icon-plus-circle2"></i></b> Add Hotel</a>
        </div>
...
<script>
    ...
    $(function () {
        $('.datatable-basic').dataTable({
            ...
            order: [[3, "desc"]],
            ajax: site_url + 'business/hotels/get_hotels/<?php echo $business_data['id'] ?>',
            columns: [
                {
                    data: "sr_no",
                    visible: true,
