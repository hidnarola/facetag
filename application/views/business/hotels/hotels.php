...
<div class="page-header page-header-default">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('business/icps'); ?>"><i class="icon-office position-left"></i> ICPs</a></li>
...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading text-right">
            <a href="<?php echo site_url('business/hotels/add/' . $icp_data['id']); ?>" class="btn btn-success btn-labeled"><b><i class="icon-plus-circle2"></i></b> Add Hotel</a>
        </div>
...
<script>
    $(function () {
        $('.datatable-basic').dataTable({
            ...
            order: [[3, "desc"]],
            ajax: site_url + 'business/hotels/get_hotels/<?php echo $icp_data['id'] ?>',
            columns: [
                {
                    data: "sr_no",
                    visible: true,
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        action = '<a href="' + site_url + 'business/hotels/edit/<?php echo $icp_data['id'] ?>/' + full.id + '" class="btn border-primary text-primary btn-flat btn-icon btn-rounded btn-xs" title="Edit Business"><i class="icon-pencil3"></i></a>';
