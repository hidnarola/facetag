...
<div class="page-header page-header-default">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('business/icps'); ?>"><i class="icon-lan2"></i> ICPs</a></li>
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="" id="icp_info" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
                ...
                <fieldset class="content-group">
                    ...
                    <div <?php echo $style ?> id="printed_souvenir_price_div">
                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <label class="radio-inline">
                                            <input type="radio" name="local_hotel_delivery_free" id="local_hotel_delivery_free" class="styled" value="1" <?php
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="local_hotel_delivery_free" id="local_hotel_delivery_free" class="styled" value="0" <?php if (isset($icp_data) && $icp_data['local_hotel_delivery_free'] == 0) echo 'checked' ?>>
                                            No
                                        </label>
                                    </div>
                                </div>
