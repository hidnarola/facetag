...
<div class="page-header page-header-default">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('admin/businesses/icp_images/' . $icp_data['id']); ?>"><i class="icon-images2"></i> ICP Images</a></li>
...
<script>
    $(function () {
        $('.datatable-basic').dataTable({
            ...
            order: [[5, "desc"]],
            ajax: site_url + 'admin/businesses/get_matched_images/<?php echo $icp_data['id'] ?>',
            columns: [
                {
                    data: "sr_no",
                    visible: true,
