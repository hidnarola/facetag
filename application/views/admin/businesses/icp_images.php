...
//                        return '';
                        return '<a href="' + base_url + icp_image_path + data + '" data-popup="lightbox"><img src="<?php echo site_url() . 'admin/businesses/get_image?image=' ?>' + base_url + icp_image_path + data + '" alt="" class="img-rounded img-preview"></a>';
