        ...
        <div class="row"> 
            ...
            <div class="heading wow fadeIn animated" data-wow-offset="120" data-wow-duration="1.5s">
                <div class="subtitle text-center ">
                    <h6>Hello <b><?php echo $user['firstname'] . ' ' . $user['lastname'] ?></b>! Please enter your Password to register for your business "<b><?php echo $business ?></b>".</h6>
                </div>
                    ...
                    <form method="post" action="" class="login-form" id="loginform">
                        <div class="step-block" id="firstblock">
                            ...
                            <div class="submit-button">
                                <input type="hidden" name="id" value="<?php echo $verification_code ?>">
                                <button class="btn btn-primary btnxs first_btn" name="first"><i class="fa fa-paper-plane"></i> &nbsp;Register for Business</button>
                            </div>
                        </div>
                    </form>
                </div>
