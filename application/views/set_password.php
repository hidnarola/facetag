        ...
        <div class="row"> 
            ...
            <div class="heading wow fadeIn animated" data-wow-offset="120" data-wow-duration="1.5s">
                ...
                <div class="subtitle text-center ">
                    <h6>Please enter your password and confirm entered password.</h6>
                </div>
                    ...
                    <form method="post" class="login-form" id="loginform">
                        <div class="step-block" id="firstblock">
                            ...
                            <div class="submit-button">
                                <button class="btn btn-primary btnxs first_btn" name="first"><i class="fa fa-paper-plane"></i> &nbsp;Set Password</button>
                            </div>
                        </div>
                    </form>
                </div>
...
>>>>>>> 3953b9284fa430959cd25bd3f245cdbb609c1f79
</script>